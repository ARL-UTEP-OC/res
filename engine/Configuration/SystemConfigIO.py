...
class SystemConfigIO():
    ...
    def readConfig(self):
        ...
        if sys.platform == "linux" or sys.platform == "linux2" or sys.platform == "darwin":
            ...
            self.config['VMWARE'] = {}
            env_path = os.path.expandvars("/home/$USERNAME/vmware/")
            ...
            env_path = os.path.expandvars("/home/$USERNAME/.vmware/preferences")
            self.config['VMWARE']['VMWARE_PREFSFILE_PATH'] = env_path
            env_path = os.path.expandvars("/home/$USERNAME/.vmware/inventory.vmls")
