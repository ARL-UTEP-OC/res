...
class ProxmoxManage(VMManage):
    ...
    def runConfigureVMNets(self, vmName, internalNets, username=None, password=None):
        try:
            ...
            try:
                ...
                proxapi = ProxmoxAPI(server, port, user=username, password=password, verify_ssl=False)
            except Exception:
            ...
            for internalnet in internalNets:
                ...
                try:
                    ...
                    proxapi.nodes(nodename)('network').post(iface=str(internalnet),node=nodename,type='bridge')
                ...
                try:
                    ...
                    result = proxapi.nodes(nodename)('qemu')(vmUUID)('config').post(**kwargs)
                except Exception:
    ...
    def runConfigureVMNet(self, vmName, netNum, netName, username=None, password=None):
        try:
            ...
            try:
                #create bridge if it doesn't exist
                proxapi.nodes(nodename)('network').post(iface=str(netName),node=nodename,type='bridge')
            except ResourceException:
    ...
    def runRemoteCmds(self, cmds, username=None, password=None):
        ...
        try:
            ...
            cmdNum = 1
            for cmd in cmds:
                logging.info("runRemoteCmds(): Running cmd # " + str(cmdNum) + " of " + len(cmds) + ": " + str(cmd))
                res = proxssh._exec(shlex.split(cmd))
                logging.info("runRemoteCmds(): Command completed: " + res)
    ...
    def snapshotVM(self, vmName, username=None, password=None):
        ...
        try:
            ...
            try:
                ...
                res = proxapi.nodes(nodename)('qemu')(vmUUID)('snapshot').post(snapname=snapname)
    ...
    def startVM(self, vmName, username=None, password=None):
        ...
        try:
            ...
            try:
                proxapi.nodes(nodename)('qemu')(vmUUID)('status')('start').post()
            except Exception:
    ...
    def pauseVM(self, vmName, username=None, password=None):
        ...
        try:
            ...
            try:
                proxapi.nodes(nodename)('qemu')(vmUUID)('status')('pause').post()
            except Exception:
    ...
    def suspendVM(self, vmName, username=None, password=None):
        ...
        try:
            ...
            try:
                proxapi.nodes(nodename)('qemu')(vmUUID)('status')('suspend').post()
            except Exception:
    ...
    def stopVM(self, vmName, username=None, password=None):
        ...
        try:
            ...
            try:
                proxapi.nodes(nodename)('qemu')(vmUUID)('status')('stop').post()
            except Exception:
    ...
    def runCloneVM(self, vmName, cloneName, cloneSnapshots=None, linkedClones=None, groupName=None, username=None, password=None):
        ...
        try:
            ...
            try:
                res = proxapi.nodes(nodename)('qemu')(vmUUID)('clone').post(newid=newid, full=0)
    ...
    def runRestoreLatestSnapVM(self, vmName, username=None, password=None):
        ...
        try:
            ...
            try:
                ...
                if latest_snap != None:
                    proxapi.nodes(nodename)('qemu')(vmUUID)('snapshot')(latest_snap)('rollback').post(start='0')
                else:
                    Exception
