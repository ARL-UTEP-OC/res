...
class KeycloakOpeningDialog(QDialog):
    def __init__(self, parent, pathToBrowser, browserArgs, userpasses, url):
        logging.debug("KeycloakOpeningDialog(): instantiated")
        super(KeycloakOpeningDialog, self).__init__(parent)
    ...
    def exec_(self):
        ...
        t.start()
        result = super(KeycloakOpeningDialog, self).exec_()
