...
class GuacOpeningDialog(QDialog):
    def __init__(self, parent, pathToBrowser, browserArgs, userpasses, url):
        logging.debug("GuacOpeningDialog(): instantiated")
        super(GuacOpeningDialog, self).__init__(parent)
    ...
    def exec_(self):
        ...
        t.start()
        result = super(GuacOpeningDialog, self).exec_()
