...
class GuacStatusWidget(QtWidgets.QWidget):
    def __init__(self, parent=None, configname=None, widgetname="", rolledoutjson=None, interest_vmnames = [], vmuser_mapping={}, status_bar=None):
        logging.debug("GuacStatusWidget instantiated")
        if configname == None:
        ...
        self.setWindowTitle("GuacStatusWidget")
        self.setObjectName("GuacStatusWidget")
    ...
    def retranslateUi(self, rolledoutjson, interest_vmnames, vmuser_mapping):
        logging.debug("GuacStatusWidget: retranslateUi(): instantiated")
        user_num = 1
