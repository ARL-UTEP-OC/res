...
class ChallengesWidget(QtWidgets.QWidget):
    ...
    def menuItemSelected(self):
        ...
        ##get server info
        vmHostname, vmserversshport, rdpBrokerHostname, chatServerIP, challengesServerIP, vmcontrolip, vmcontrolsshport, users_file = self.eco.getExperimentServerInfo(configname)
