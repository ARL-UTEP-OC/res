...
#("VM Name", "Generated User", "Generated Pass", "UserID", "TeamName/ID", "Rank", "Score", "Team Score")
    ...
    def menuItemSelected(self):
        ...
        vmserverip, vmserversshport, rdpbroker, chatserver, challengesserver, vmcontrolip, vmcontrolsshport, users_file = self.eco.getExperimentServerInfo(self.configname)
